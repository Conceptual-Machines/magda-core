    ...
    static const std::vector<LLMPreset> presets = {
        {
            ...
            "Local (Embedded)",
            {
                ...
                {role::CHORD, {provider::LLAMA_LOCAL, "", "", ""}},
        ...
        },
        {
            ...
            "Local Server (OpenAI-compatible)",
            {
                ...
                {role::CHORD, {provider::LOCAL_SERVER, "", "", ""}},
        ...
        },
        {
            ...
            "Cloud (OpenAI)",
            {
                ...
                {role::CHORD, {provider::OPENAI_RESPONSES, "", "", model::GPT_5_5}},
        ...
        },
        {
            ...
            "Cloud (Anthropic)",
            {
                ...
                {role::CHORD, {provider::ANTHROPIC, "", "", model::CLAUDE_OPUS}},
        ...
        },
        {
            ...
            "Cloud (Gemini)",
            {
                ...
                {role::CHORD, {provider::GEMINI, "", "", model::GEMINI_PRO}},
        ...
        },
        {
            ...
            "Cloud (DeepSeek)",
            {
                ...
                {role::CHORD, {provider::DEEPSEEK, "", "", model::DEEPSEEK_REASONER}},
        ...
        },
        {
            ...
            "Cloud (OpenRouter)",
            {
                ...
                {role::CHORD, {provider::OPENROUTER, "", "", model::LLAMA_70B}},
        ...
        },
        {
            ...
            "Hybrid - Optimize for Speed",
            {
                ...
                {role::CHORD, {provider::OPENAI_RESPONSES, "", "", model::GPT_5_MINI}},
        ...
        },
        {
            ...
            "Hybrid - Optimize for Quality",
            {
                ...
                {role::CHORD, {provider::OPENAI_RESPONSES, "", "", model::GPT_5_4}},
                {role::CONTROLLER, {provider::OPENAI_RESPONSES, "", "", model::GPT_5_MINI}},
            },
        },
    };
