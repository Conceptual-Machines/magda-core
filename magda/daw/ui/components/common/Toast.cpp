...
Toast::Toast() {
    ...
    label_.setColour(juce::Label::textColourId, ActiveTheme::getColour(ActiveTheme::TEXT_BRIGHT));
...
void Toast::paint(juce::Graphics& g) {
    ...
    auto bgColour = ActiveTheme::getColour(ActiveTheme::TOAST_BACKGROUND).withAlpha(0.92f);
    g.setColour(bgColour);
    g.fillRoundedRectangle(bounds, 6.0f);

    g.setColour(ActiveTheme::getColour(ActiveTheme::ACCENT_PRIMARY_SOFT).withAlpha(0.6f));
