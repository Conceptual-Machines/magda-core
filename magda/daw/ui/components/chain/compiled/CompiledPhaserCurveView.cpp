...
void CompiledPhaserCurveView::bindDevice(std::shared_ptr<magda::daw::audio::MagdaDevice> device) {
    setCompiledPlugin(
        std::dynamic_pointer_cast<magda::daw::audio::compiled::MagdaPhaserCompiledPlugin>(
            std::move(device)));
}
