...
/**
 * @brief LookAndFeel for inspector combo boxes with 12pt Inter font and chevron arrow
 */
class InspectorComboBoxLookAndFeel : public juce::LookAndFeel_V4 {
  public:
    InspectorComboBoxLookAndFeel() = default;
    ~InspectorComboBoxLookAndFeel() override = default;
    ...
    static InspectorComboBoxLookAndFeel& getInstance() {
        static InspectorComboBoxLookAndFeel instance;
        return instance;
    }

  private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(InspectorComboBoxLookAndFeel)
};
