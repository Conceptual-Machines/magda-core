...
pitchSemis = hslider("Pitch [unit:st] [idx:1]", 7.0, -24.0, 24.0, 0.01) : msm.smooth(ba.tau2pole(0.05));
...
mix        = hslider("Mix [idx:4]", 0.5, 0.0, 1.0, 0.001) : msm.smooth(ba.tau2pole(0.02));
