...
pitchSemis = hslider("Pitch [unit:st] [idx:1]", 0.1, -24.0, 24.0, 0.01) : msm.smooth(ba.tau2pole(0.05));
fineCents  = hslider("Fine [unit:cents] [idx:2]", 12.0, -100.0, 100.0, 0.1) : msm.smooth(ba.tau2pole(0.05));
