...
window   = vgroup("Engine", nentry("Window[idx:1][width:3][style:radio{'1/8':0;'1/4':1;'1/2':2;'1 Bar':3}][tooltip: Reverse window size, from rapid backward glitch repeats to a standard one-bar phrase reversal.]", 0, 0, 3, 1));
