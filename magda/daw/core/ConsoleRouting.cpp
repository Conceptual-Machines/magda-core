...
const std::vector<AgentSurface>& registeredAgentSurfaces() {
    ...
    static const std::vector<AgentSurface> surfaces = {
        {.id = AgentSurfaceId::Arrangement,
         ...
         .toolAllowlist =
             {
                 "project.get",         "project.save",
                 "project.setTempo",    "project.setTimeSignature",
                 "tracks.list",         "tracks.get",
                 "tracks.create",       "tracks.update",
                 "tracks.delete",       "clips.list",
                 "clips.get",           "clips.createMidi",
                 "clips.addMidiNote",   "clips.delete",
                 "devices.list",        "devicePresets.list",
                 "devices.setBypassed", "racks.create",
                 "racks.remove",        "racks.setBypassed",
