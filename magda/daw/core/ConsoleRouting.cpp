    ...
    static const std::vector<AgentSurface> surfaces = {
        ...
        {.id = AgentSurfaceId::PianoRoll,
         ...
         .contextProviders = {Provider::ProjectRevision, Provider::ActiveView, Provider::Selection,
                              ...
                              Provider::Conversation},
         .toolAllowlist = {"project.get",       "chordTrack.get",
                           "chordTrack.ensure", "chordTrack.replaceProgression",
                           "tracks.list",       "tracks.get",
                           "clips.list",        "clips.get",
                           "clips.createMidi",  "clips.addMidiNote",
                           "clips.delete",      "clips.move",
                           "clips.resize",      "clips.duplicate",
                           "clips.update",      "clips.transpose",
                           "clips.quantize",    "clips.sliceNotes",
