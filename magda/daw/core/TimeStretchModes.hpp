...
// engine bridge is a cast and a static_assert in audio/EngineEnumPins.cpp holds
// that equality. If the engine ever renumbers, the bridge grows a mapping -
// these values do not move.
