...
TEST_CASE("agent surface registry has distinct bounded capabilities", "[console_routing]") {
    ...
    REQUIRE(containsTool(automation, "automation.listClips"));
    REQUIRE(containsTool(automation, "automation.createClip"));
    REQUIRE(containsTool(automation, "automation.updateClip"));
    ...
    REQUIRE(containsTool(device, "mods.create"));
    REQUIRE(containsTool(device, "mods.link"));
    REQUIRE(containsTool(device, "macros.list"));
    REQUIRE(containsTool(device, "macros.link"));
    REQUIRE(containsTool(device, "devices.setParameterConfig"));
    REQUIRE(containsTool(device, "devices.add"));
    REQUIRE(containsTool(device, "devices.replace"));
