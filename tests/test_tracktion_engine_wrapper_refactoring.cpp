...
TEST_CASE("TracktionEngineWrapper - Constants are properly defined", "[engine][refactoring][constants]") {
...
TEST_CASE("TracktionEngineWrapper - Construction and destruction", "[engine][refactoring][lifecycle]") {
...
TEST_CASE("TracktionEngineWrapper - Transport operations with refactored code", "[engine][refactoring][transport]") {
    magda::TracktionEngineWrapper wrapper;
    wrapper.initialize();
...
TEST_CASE("TracktionEngineWrapper - Bridge access after refactoring", "[engine][refactoring][bridges]") {
    magda::TracktionEngineWrapper wrapper;
    wrapper.initialize();
...
TEST_CASE("TracktionEngineWrapper - Refactored initialization order", "[engine][refactoring][init-order]") {
...
TEST_CASE("TracktionEngineWrapper - Error handling in initialization", "[engine][refactoring][errors]") {
...
TEST_CASE("TracktionEngineWrapper - DeviceManager access", "[engine][refactoring][device-manager]") {
    magda::TracktionEngineWrapper wrapper;
    wrapper.initialize();
...
TEST_CASE("TracktionEngineWrapper - Full lifecycle integration test", "[engine][refactoring][integration]") {
...
TEST_CASE("TracktionEngineWrapper - Refactoring preserves thread safety", "[engine][refactoring][threading]") {
